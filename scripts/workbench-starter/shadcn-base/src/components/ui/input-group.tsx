...
>(
  function InputGroup({
    ...
    const Control = control === "textarea" ? InputGroupTextarea : InputGroupInput
          ...
          <>
            ...
            {(showClearButton || shortcut) && (
              <InputGroupAddon align="inline-end">
                ...
                {shortcut && <InputGroupText>{shortcut}</InputGroupText>}
              </InputGroupAddon>
            )}
          </>
        )}
...
function isMeaningfulInputGroupChild(child: React.ReactNode): boolean {
  ...
  "flex items-center gap-2 text-sm shadow-none",
  {
    variants: {
      size: {
        ...
        sm: "",
        "icon-xs":
          "size-6 rounded-[calc(var(--radius)-3px)] p-0 has-data-[icon=inline-end]:pr-0 has-data-[icon=inline-start]:pl-0 has-[>svg]:p-0",
        "icon-sm":
          "size-8 p-0 has-data-[icon=inline-end]:pr-0 has-data-[icon=inline-start]:pl-0 has-[>svg]:p-0",
      },
    },
    defaultVariants: {
      size: "xs",
