...
function ToastTrigger({
  ...
  const slottedChildren = React.Children.toArray(children).filter(
    React.isValidElement
  ) as React.ReactElement<ToastTriggerChildProps>[]
  const trigger =
    slottedChildren.find((child) => child.props.slot === "trigger") ??
    slottedChildren[0]
  ...
  const showToast = React.useCallback(() => {
    ...
    toastId = toast.add({
      ...
      description,
      timeout: duration,
      type: toastType === "default" ? undefined : toastType,
  ...
  }, [actionLabel, description, duration, title, toastType])
