import { AstryxPowerSearchItem as Component } from './AstryxPowerSearchItem';
...
const meta = {
  ...
  authoring: {
    allowedChildren: ['AstryxPowerSearchEditor'],
    group: 'Inputs',
...
export default meta;
export const AstryxPowerSearchItem = {
  name: 'AstryxPowerSearchItem',
